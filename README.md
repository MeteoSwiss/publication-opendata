*Status:* DRAFT <br>
*Maintainer:* Federal Office of Meteorology and Climatology MeteoSwiss, [OGD@MeteoSwiss project core team](mailto:opendata@meteoswiss.ch) <br>
...
2. [Open data products](https://github.com/MeteoSwiss/publication-opendata/tree/master#2-open-data-products-de-fr-it)
    ...
    - 2.5. [Grid data](https://github.com/MeteoSwiss/publication-opendata/tree/main#25-grid-data)
        ...
        - 2.5.x. [Radar and compiprecip data](https://github.com/MeteoSwiss/publication-opendata/tree/main#252-Spatial-climate-data)
