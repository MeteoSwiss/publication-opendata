...
| gXX: [Bodengestützte räumliche Klimadaten – Gitterdaten](#261-spatial-climate-data), `ogd-surface-derived-grid` <br> gXX: [Satellitengestützte räumliche Klimadaten – Gitterdaten](#261-spatial-climate-data), `ogd-satellite-derived-grid` <br> | gXX: Radargestützte räumliche Klimadaten – Gitterdaten, `ogd-radar-derived-grid` <br> |              |
