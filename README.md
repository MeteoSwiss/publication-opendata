...
| **Atmosphärendaten** |           | [Radiosondierungen – Messwerte](#241-radio-soundings-radiosounding), `ogd-radiosounding` <br> | ~~Windprofiler (rwp & dl)~~ (finanziert durch ENSI) <br> Raman-LIDAR for Meteorological Observation (RALMO) <br> LIDAR Ceilometer CHM15K <br> ~~Ceilometer-Messnetz~~ (finanziert durch REGA) <br> ~~Mikrowellen-Radiometrie~~ (finanziert durch ENSI) <br> Ozonmessungen (Dobson, Brewer, O3-Radiosondierungen und SOMORA) <br> Swiss Alpine Climate Radiation Monitoring SACRaM <br> |
