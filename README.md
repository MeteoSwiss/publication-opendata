...
| :-----------| :----------- | :---------- | :----------- |
| **Hauptfunktionalitäten** | Einzelne oder mehrere Files über die STAC-API der BGDI herunterladen |  Einzelne oder mehrere Files über ein WebGUI zum Download auswählen |              |
| **Bodenstationsdaten** | [Automatische Wetterstationen – Messwerte](#231-automatic-weather-stations-smn-smn-precip-smn-tower), `ogd-smn` <br> <br> [Automatische Niederschlagsstationen – Messwerte](#231-automatic-weather-stations-smn-smn-precip-smn-tower), `ogd-smn-precip` <br> <br> [Automatische Grenzschichtstationen – Messwerte](#231-automatic-weather-stations-smn-smn-precip-smn-tower), `ogd-smn-tower` <br> <br> [Manuelle Niederschlagsstationen – Messwerte](#232-manual-precipitation-stations-nime-tot), `ogd-nime` <br> <br> [Totalisator-Niederschlagsstationen – Messwerte](#232-manual-precipitation-stations-nime-tot), `ogd-tot` <br> <br> [Pollenstationen – Messwerte](#235-swiss-pollen-monitoring-stations-pollen), `ogd-pollen` <br> |             |              |
| **Atmosphärendaten** | [Radiosondierungen – Messwerte](#241-radio-soundings-radiosounding), `ogd-radiosounding` <br> |           | ~~Windprofiler (rwp & dl)~~ (finanziert durch ENSI) <br> <br> Raman-LIDAR for Meteorological Observation (RALMO) <br> <br> LIDAR Ceilometer CHM15K <br> <br> ~~Ceilometer-Messnetz~~ (finanziert durch REGA) <br> <br> ~~Mikrowellen-Radiometrie~~ (finanziert durch ENSI) <br> <br> Ozonmessungen (Boden: Dobson, Brewer; Atmosphäre: O3-Radiosondierungen, SOMORA) <br> <br> Swiss Alpine Climate Radiation Monitoring SACRaM <br> |
| **Beobachtungen** | [Meteorologische Augenbeobachtungen](#233-visual-observations-obs), `ogd-obs` <br> <br> [Phänologische Beobachtungen](#236-phenological-observations-phenology), `ogd-phenology` <br> |              |              |
| **Klimadaten** | [Klimastationen – Homogene Messwerte](#234-climate-stations-swiss-nbcn-nbcn-nbcn-precip), `ogd-nbcn` <br> <br> [Niederschlags-Klimastationen – Homogene Messwerte](#234-climate-stations-swiss-nbcn-nbcn-nbcn-precip), `ogd-nbcn-precip` <br> |             |              |
| | [Bodengestützte räumliche Klimadaten – Gitterdaten](#261-spatial-climate-data), `ogd-surface-derived-grid` <br> <br> [Satellitengestützte räumliche Klimadaten – Gitterdaten](#261-spatial-climate-data), `ogd-satellite-derived-grid` <br> | Radargestützte räumliche Klimadaten – Gitterdaten, `ogd-radar-derived-grid` <br> |              |
| | Klima-Normwerte, `ogd-climate-normals` <br> | Klima-Normwerte – Gitterdaten, `ogd-climate-normals-grid` <br> | Klimaszenarien – ..., `ogd-climate-scenarios` <br> | 
...
| | [Lokalprognosedaten](#253-postprocessed-local-forecast-data-data4web), `ogd-local-forecasting` <br> |             |             | 
...
Con l'introduzione della [Revisione totale dell’ordinanza sulla meteorologia e la climatologia (OMet)](https://fedlex.data.admin.ch/eli/dl/proj/2022/77/cons_1) - previsto per il 1° trimestre del 2025 - MeteoSvizzera esenterà dalle tasse i dati raccolti nell'ambito del mandato legale, implementando così l'accesso ai dati aperti, come richiesto dalla [Legge federale
