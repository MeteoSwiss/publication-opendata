...
| [Automatische Wetterstationen – Messwerte](#231-automatic-weather-stations-smn-smn-precip-smn-tower), `ogd-smn`, 01 <br> [Automatische Niederschlagsstationen – Messwerte](#231-automatic-weather-stations-smn-smn-precip-smn-tower), `ogd-smn-precip`, 02 <br> [Automatische Grenzschichtstationen – Messwerte](#231-automatic-weather-stations-smn-smn-precip-smn-tower), `ogd-smn-tower`, 03 <br> [Manuelle Niederschlagsstationen – Messwerte](#232-manual-precipitation-stations-nime-tot), `ogd-nime`, 04 <br> [Totalisator-Niederschlagsstationen – Messwerte](#232-manual-precipitation-stations-nime-tot), `ogd-tot`, 05 <br> [Pollenstationen – Messwerte](#235-swiss-pollen-monitoring-stations-pollen), `ogd-pollen`, 10 | [Radiosondierungen – Messwerte](#241-radio-soundings-radiosounding), `ogd-radiosounding` (12) |              |
| [Meteorologische Augenbeobachtungen](#233-visual-observations-obs), `ogd-obs`, 06 <br> [Phänologische Beobachtungen](#236-phenological-observations-phenology), `ogd-phenology`, 11 |              |              | 
| [Klimastationen – Homogene Messwerte](#234-climate-stations-swiss-nbcn-nbcn-nbcn-precip), `ogd-nbcn`, 07 <br> [Niederschlags-Klimastationen – Homogene Messwerte](#234-climate-stations-swiss-nbcn-nbcn-nbcn-precip), `ogd-nbcn-precip`, 08 |             |              | 
...
|              | [Lokalprognosedaten – Punktdaten](#253-postprocessed-local-forecast-data-data4web), `ogd-local-forecasting`, 15 <br> [Klimanormwerte – Punktdaten](), `ogd-climate-normals`, xx |              | 
