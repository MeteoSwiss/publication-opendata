...
| **Atmosphärendaten** |           | [Radiosondierungen – Messwerte](#241-radio-soundings-radiosounding), `ogd-radiosounding` | weitere Atmosphärendaten (in Abklärung) <br> |
...
| **Klimadaten** | [Klimastationen – Homogene Messwerte](#234-climate-stations-swiss-nbcn-nbcn-nbcn-precip), `ogd-nbcn` <br> [Niederschlags-Klimastationen – Homogene Messwerte](#234-climate-stations-swiss-nbcn-nbcn-nbcn-precip), `ogd-nbcn-precip` <br> |             |              |
| | [Bodengestützte räumliche Klimadaten – Gitterdaten](#261-spatial-climate-data), `ogd-surface-derived-grid` <br> [Satellitengestützte räumliche Klimadaten – Gitterdaten](#261-spatial-climate-data), `ogd-satellite-derived-grid` <br> | Radargestützte räumliche Klimadaten – Gitterdaten, `ogd-radar-derived-grid` <br> |              |
| | Klimanormwerte – Punktdaten, `ogd-climate-normals` <br> | Klimanormwerte – Gitterdaten, `ogd-climate-normals-grid` <br> | Klimaszenarien – ..., `ogd-climate-scenario` <br> | 
| **Radardaten** | [Grundlegende Radardaten – Gitterdaten](#262-radar-and-combiprecip-data), `ogd-basic-radar` <br> [Erweiterte Radardaten – Gitterdaten](#262-radar-and-combiprecip-data), `ogd-advanced-radar` <br>  | [Kombinierte Niederschlagsberechnungen – Gitterdaten](#2623-combiprecip-data), `ogd-combiprecip` <br> | 3D-Radardaten (in Abklärung) <br> | 
| **Prognosedaten** | [Kurzfristprognosedaten – Gitterdaten](#251-inca-data-nowcasting), `ogd-nowcasting` <br> | [ICON-CH1-Prognosedaten – Gitterdaten](#252-cosmoicon-data-forecasting), `ogd-forecasting-icon-ch1` <br> [ICON-CH2-Prognosedaten – Gitterdaten](#252-cosmoicon-data-forecasting), `ogd-forecasting-icon-ch2` <br> |             | 
